...
public class ServerHandler  extends ChannelInboundHandlerAdapter{
	...
	public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {//客户端发消息来的时候进到这里来
		...
		System.out.println("服务端接到客户端消息为 : " + body + ++counter);
		
		
		String currentTime = "QUERY TIME ORDER".equalsIgnoreCase(body)
				? new java.util.Date(System.currentTimeMillis()).toString() : "fuwuduanfageikeuhduan"+ System.getProperty("line.separator");
